                    ...
                    <div className="nav">
                        ...
                        {user && user.roleId === 'R1' && (
                            <>
                                ...
                                >
                                    <nav className="sb-sidenav-menu-nested nav">
                                        <Link to={'/admin/list-category'} className="nav-link">
                                            Danh sách danh mục
                                        </Link>
                                ...
                                >
                                    <nav className="sb-sidenav-menu-nested nav">
                                        <Link to={'/admin/list-brand'} className="nav-link">
                                            Danh sách nhãn hàng
                                        </Link>
                                ...
                                >
                                    <nav className="sb-sidenav-menu-nested nav">
                                        <Link to={'/admin/list-subject'} className="nav-link">
                                            Danh sách chủ đề
                                        </Link>
                                        <Link to={'/admin/add-subject'} className="nav-link">
                                            Thêm chủ đề
                                        </Link>
                                    </nav>
                                </div>
                                ...
                                >
                                    <nav className="sb-sidenav-menu-nested nav">
                                        <Link to={'/admin/list-blog'} className="nav-link">
                                            Danh sách bài đăng
                                        </Link>
                                        <Link to={'/admin/add-blog'} className="nav-link">
                                            Thêm bài đăng
                                        </Link>
                                    </nav>
                                </div>
                                ...
                                >
                                    <nav className="sb-sidenav-menu-nested nav">
                                        <Link to={'/admin/list-typeship'} className="nav-link">
                                            DS loại giao hàng
                                        </Link>
                                        <Link to={'/admin/add-typeship'} className="nav-link">
                                            Thêm loại giao hàng
                                        </Link>
                                    </nav>
                                </div>
                                ...
                                >
                                    <nav className="sb-sidenav-menu-nested nav">
                                        <Link to={'/admin/list-typevoucher'} className="nav-link">
                                            DS loại khuyến mãi
                                        </Link>
                                        <Link to={'/admin/list-voucher'} className="nav-link">
                                            DS mã khuyến mãi
                                        </Link>
                                        <Link to={'/admin/add-typevoucher'} className="nav-link">
                                            Thêm loại khuyến mãi
                                        </Link>
                                        <Link to={'/admin/add-voucher'} className="nav-link">
                                            Thêm mã khuyến mãi
                                        </Link>
                                    </nav>
                                </div>
                        ...
                        >
                            <nav className="sb-sidenav-menu-nested nav">
                                <Link to={'/admin/list-supplier'} className="nav-link">
                                    Danh sách NCC
                                </Link>
                                <Link to={'/admin/add-supplier'} className="nav-link">
                                    Thêm nhà cung cấp
                                </Link>
                            </nav>
                        </div>
                        ...
                        >
                            <nav className="sb-sidenav-menu-nested nav">
                                <Link to={'/admin/list-receipt'} className="nav-link">
                                    Danh sách nhập hàng
                                </Link>
                                <Link to={'/admin/add-receipt'} className="nav-link">
                                    Thêm nhập hàng
                                </Link>
                            </nav>
                        </div>
                        ...
                        {user && user.roleId === 'R1' && (
                            <>
                                ...
                                >
                                    <nav className="sb-sidenav-menu-nested nav">
                                        <Link to={'/admin/turnover'} className="nav-link">
                                            Thống kê doanh thu
                                        </Link>

                                        <Link to={'/admin/profit'} className="nav-link">
                                            Thống kê lợi nhuận
                                        </Link>
                                        <Link to={'/admin/stock-product'} className="nav-link">
                                            Thống kê tồn kho
                                        </Link>
                                    </nav>
                                </div>
