        ...
        <div className="container-fluid px-4">
            ...
            <div className="card mb-4">
                ...
                <div className="card-body">
                                    ...
                                    dataOrder.map((item, index) => {
                                        return (
                                            <tr key={index}>
                                                ...
                                                <td>
                                                    {moment.utc(item.updatedAt).local().format('DD/MM/YYYY HH:mm:ss')}
                                                </td>
                    ...
                    <span style={{ fontSize: '26px' }} className="text-total">
                        Tổng doanh thu:{' '}
                    </span>
                    <span style={{ color: '#71cd14', fontSize: '26px' }} className="text-price">
                        {CommonUtils.formatter.format(totalPrice)}
                    </span>
                </div>
            </div>
        </div>
