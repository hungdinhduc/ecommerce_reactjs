                                ...
                                <div className="col-md-12">
                                    <div className="p-3 py-5">
                                        ...
                                        <div className="row mt-2">
                                            <div className="col-md-12">
                                                <label className="labels">Loại hàng hóa</label>
                                                <select
                                        ...
                                        <div className="row mt-2">
                                            <div className="col-md-12">
                                                <label className="labels">Số tiền</label>
                                                <input
                                                    name="amount"
                                                    disabled={true}
                                        ...
                                        <div className="row mt-2">
                                            <div className="col-md-12">
                                                <label className="labels">Nội dung thanh toán</label>
                                                <input
                                        ...
                                        <div className="row mt-2">
                                            <div className="col-md-12">
                                                <label className="labels">Ngân hàng</label>
                                                <select
