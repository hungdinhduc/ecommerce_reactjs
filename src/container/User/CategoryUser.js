            ...
            <ul className="list-category">
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li>
                            <Link to={`/user/changepassword/${props.id}`}>Đổi mật khẩu</Link>
                        </li>
                    </ul>
                </li>
                <li>
                    <img width="20px" height="20px" style={{ marginLeft: '-3px' }} src={orderLogo}></img>{' '}
                    <Link to={`/user/order/${props.id}`}>Đơn mua</Link>
                </li>
                <li>
                    <img width="20px" height="20px" style={{ marginLeft: '-3px' }} src={storeVoucherLogo}></img>{' '}
                    <Link to={`/user/store-voucher/${props.id}`}>Kho voucher</Link>
                </li>
            </ul>
        </div>
    );
